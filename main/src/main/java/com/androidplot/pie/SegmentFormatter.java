...
public class SegmentFormatter extends Formatter<PieChart> {
	...
	private static final float DEFAULT_EDGE_THICKNESS = 10;
	...
	public SegmentFormatter(Integer fillColor, Integer borderColor, Context ctx) {
		this(fillColor);
		...
		try
		{
			...
			getLabelPaint().setTextSize(dip * scale + 0.5f);
		}
		catch (Exception ex)
		{
