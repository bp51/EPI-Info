...
public class MatchedPairActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lblsH1 = (TextView) findViewById(R.id.lblH1);
        lblsH2 = (TextView) findViewById(R.id.lblH2);
        lblsV1 = (TextView) findViewById(R.id.lblV1);
        lblsV2 = (TextView) findViewById(R.id.lblV2);
        lblsTotal = (TextView) findViewById(R.id.lblTotal);
        
        lblOdds = (TextView) findViewById(R.id.lblOdds);
        lblOddsLower = (TextView) findViewById(R.id.lblOddsLower);
        lblOddsUpper = (TextView) findViewById(R.id.lblOddsUpper);
        lblFisherLower = (TextView) findViewById(R.id.lblFisherLower);
        lblFisherUpper = (TextView) findViewById(R.id.lblFisherUpper);
        lblChiSqUnc = (TextView) findViewById(R.id.lblChiSqUnc);
        lblPUnc = (TextView) findViewById(R.id.lblPUnc);
        lblChiSqCor = (TextView) findViewById(R.id.lblChiSqCor);
        lblPCor = (TextView) findViewById(R.id.lblPCor);
        lblFisher1T = (TextView) findViewById(R.id.lblFisher1T);
        lblFisher2T = (TextView) findViewById(R.id.lblFisher2T);
