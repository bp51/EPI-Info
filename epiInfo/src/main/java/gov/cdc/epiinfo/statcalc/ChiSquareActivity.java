...
public class ChiSquareActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lblChi = (TextView) findViewById(R.id.lblChi);
        lblOr1 = (TextView) findViewById(R.id.lblOr1);
        lblOr2 = (TextView) findViewById(R.id.lblOr2);
        lblOr3 = (TextView) findViewById(R.id.lblOr3);
        lblOr4 = (TextView) findViewById(R.id.lblOr4);
        lblOr5 = (TextView) findViewById(R.id.lblOr5);
        lblOr6 = (TextView) findViewById(R.id.lblOr6);
        lblOr7 = (TextView) findViewById(R.id.lblOr7);
        lblOr8 = (TextView) findViewById(R.id.lblOr8);
        lblOr9 = (TextView) findViewById(R.id.lblOr9);
        lblOr10 = (TextView) findViewById(R.id.lblOr10);
        lblPValue = (TextView) findViewById(R.id.lblPValue);
        ...
        txtA5 = (EditText) findViewById(R.id.txtA5);
        txtA6 = (EditText) findViewById(R.id.txtA6);
        txtA7 = (EditText) findViewById(R.id.txtA7);
        txtA8 = (EditText) findViewById(R.id.txtA8);
        txtA9 = (EditText) findViewById(R.id.txtA9);
        txtA10 = (EditText) findViewById(R.id.txtA10);
        ...
        txtB6 = (EditText) findViewById(R.id.txtB6);
        txtB7 = (EditText) findViewById(R.id.txtB7);
        txtB8 = (EditText) findViewById(R.id.txtB8);
        txtB9 = (EditText) findViewById(R.id.txtB9);
        txtB10 = (EditText) findViewById(R.id.txtB10);
        ...
        txtC5 = (EditText) findViewById(R.id.txtC5);
        txtC6 = (EditText) findViewById(R.id.txtC6);
        txtC7 = (EditText) findViewById(R.id.txtC7);
        txtC8 = (EditText) findViewById(R.id.txtC8);
        txtC9 = (EditText) findViewById(R.id.txtC9);
        txtC10 = (EditText) findViewById(R.id.txtC10);
