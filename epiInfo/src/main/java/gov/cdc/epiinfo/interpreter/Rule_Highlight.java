...
public class Rule_Highlight extends EnterRule
{
    boolean IsExceptList = false;
    String[] IdentifierList = null;

    public Rule_Highlight(Rule_Context pContext, Reduction pToken) 
    {
    	super(pContext);
    ...
    {
        this.Context.CheckCodeInterface.Highlight(this.IdentifierList, this.IsExceptList);
        return null;
    }
}
