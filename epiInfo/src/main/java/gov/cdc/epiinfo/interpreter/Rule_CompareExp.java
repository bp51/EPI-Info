...
public class Rule_CompareExp extends EnterRule 
{
    ...
    public Rule_CompareExp(Rule_Context pContext, Reduction pToken)
    {
        ...
        if (pToken.size() > 1)
        {
            ...
            {
                this.CompareExp = EnterRule.BuildStatements(pContext, (Reduction) pToken.get(2).asReduction());
            }
        }
    }
    ...
    public Object Execute()
    {
        ...
        else
        {
            ...
            else if (op.equalsIgnoreCase("LIKE"))
            {
                ...
                if (java.util.regex.Pattern.matches(testValue, LHSO.toString()))
                {
                    result = true;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        i = ((Comparable)LHSO).compareTo((Comparable)RHSO);
                    }
