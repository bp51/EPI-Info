...
public class Rule_Clear extends EnterRule
{
    boolean IsExceptList = false;
    String[] IdentifierList = null;

    public Rule_Clear(Rule_Context pContext, Reduction pToken) 
    {
    	super(pContext);
    ...
    {
        this.Context.CheckCodeInterface.Clear(this.IdentifierList, this.IsExceptList);
        return null;
    }
}
