...
public class Rule_Assign extends EnterRule
{
	...
	public Object Execute()
	{
		...
		if (result == null)
		{
			if (((Rule_Value)value).Id.toLowerCase().contains("syslatitude") || ((Rule_Value)value).Id.toLowerCase().contains("syslongitude") || ((Rule_Value)value).Id.toLowerCase().contains("sysbarcode") || ((Rule_Value)value).Id.toLowerCase().contains("sysaudio") || ((Rule_Value)value).Id.toLowerCase().contains("sysvideo"))
			{
	...
	private Object CheckSystemVariables(Object result)
	{
		...
		else if (result.toString().toUpperCase().equals("SYSLATITUDE"))
		{
			...
			{
				return GeoLocation.CurrentLocation.getLatitude();
			}
			else
			{
				return "";
		...
		else if (result.toString().toUpperCase().equals("SYSLONGITUDE"))
		{
			if (GeoLocation.CurrentLocation != null)
			{
				return GeoLocation.CurrentLocation.getLongitude();
			}
			else
			{
				return "";
