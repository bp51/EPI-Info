...
public class FormLayoutManager {
	...
	private void InitForm(ViewGroup layout)
	{
		...
		for (int x=0;x<formMetadata.Fields.size();x++)
		{
			...
			{
				field.setId(AddDateField(layout, field.getPrompt(), field.getX(), field.getY(), field.getPromptX(), field.getPromptY(), field.getFieldWidth(), field.getFieldHeight(), field.getPagePosition(), field.getPromptFontSize(), field.getFieldFontSize(), field.getLowerDate(), field.getUpperDate()));
			}
			else if (field.getType().equals("8"))
			{
				field.setId(AddTimeField(layout, field.getPrompt(), field.getX(), field.getY(), field.getPromptX(), field.getPromptY(), field.getFieldWidth(), field.getFieldHeight(), field.getPagePosition(), field.getPromptFontSize(), field.getFieldFontSize()));
			}
			...
			{
				field.setId(AddOptionField(layout, field.getPrompt(), field.getListValues(), field.getX(), field.getY(), field.getPromptX(), field.getPromptY(), field.getFieldWidth(), field.getFieldHeight(), field.getPagePosition(), field.getPromptFontSize(), field.getFieldFontSize(), checkCode + System.getProperty("line.separator")));
			}
