...
public class InterviewLayoutManager {
	...
	private void InitForm(ViewGroup layout)
	{
		...
		for (int x=0;x<formMetadata.Fields.size();x++)
		{
			...
			{
				field.setId(AddDateField(pages.get(field.getPageName()), field.getPrompt(), field.getX(), field.getY(), field.getPromptX(), field.getPromptY(), field.getFieldWidth(), field.getFieldHeight(), field.getPagePosition(), field.getPromptFontSize(), field.getFieldFontSize(), field.getLowerDate(), field.getUpperDate()));
			}
			else if (field.getType().equals("8"))
			{
				field.setId(AddTimeField(pages.get(field.getPageName()), field.getPrompt(), field.getX(), field.getY(), field.getPromptX(), field.getPromptY(), field.getFieldWidth(), field.getFieldHeight(), field.getPagePosition(), field.getPromptFontSize(), field.getFieldFontSize()));
			}
			...
			{
				field.setId(AddOptionField(pages.get(field.getPageName()), field.getPrompt(), field.getListValues(), field.getX(), field.getY(), field.getPromptX(), field.getPromptY(), field.getFieldWidth(), field.getFieldHeight(), field.getPagePosition(), field.getPromptFontSize(), field.getFieldFontSize(), checkCode + System.getProperty("line.separator")));
			}
	...
	public int AddTimeField(ViewGroup myLayout, String prompt, double x, double y, double promptX, double promptY, double fieldWidth, double fieldHeight, int pagePosition, double promptFontSize, double fieldFontSize)
	{
		fieldCounter++;
	...
	public int AddDateField(ViewGroup myLayout, String prompt, double x, double y, double promptX, double promptY, double fieldWidth, double fieldHeight, int pagePosition, double promptFontSize, double fieldFontSize, Date lowerDate, Date upperDate)
	{
		fieldCounter++;
		View label = AddLabel(myLayout, prompt, promptX, promptY, pagePosition, promptFontSize);
	...
	public int AddOptionField(ViewGroup myLayout, String prompt, LinkedList<String> listValues, double x, double y, double promptX, double promptY, double fieldWidth, double fieldHeight, int pagePosition, double promptFontSize, double controlFontSize, String checkCodeAfter)
	{
		fieldCounter++;
