                                   ...
                                   ParseResultConstants
{
    ...
    public boolean loadCompiledGrammar(BufferedInputStream pBufferedInputStream) throws ParserException
    {
        SimpleDatabase sdb = new SimpleDatabase(pBufferedInputStream);
     ...
     * reset all information from previous source files.
 	 ...
 	 ***************************************************************/
    public boolean loadText(String text) throws ParserException
    {
        reset();
	    pSource = new LookAheadStream();
    	pSource.loadText(text);
        prepareToParse();
